...
<?php if($res=='news'){?>
    ...
    <div class="form">
        <form name="news_form" id="news_form" action="<?php echo base_url('/resources/submit/news');?>" method="post">
            <table class="form_table">
                ...
                <tr>
                    <td colspan="2"><textarea name="content" cols="50" rows="6" class="required" ></textarea></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <div class="form_submit"><a class="submit" id="submit">Submit</a>
                        </div>
                    </td>
                </tr>
            </table>
    ...
    <div class="form">
        <form name="events_form" id="events_form" action="<?php echo base_url('/resources/submit/events');?>" method="post">
            <table class="form_table">
                ...
                <tr>
                    <td class="label">Event Full Name:</td>
                    <td>
