			...
			<div class="form-page" id="page2">
				...
				<div class="labels">
					...
					<label>
						...
						<input type="radio" id="radio1" name="is_author" data-bind="checked:is_author" value="Yes" />Yes
					...
					<label>
						...
						<input type="text" class="previous_simulator" name="pre_simulator" data-bind="value:pre_simulator" />
