...
<?php extend('layouts/layout.php'); ?>
    ...
    <div class="page-subtitle">
        <span class="page-subtitle-title">Post Topics</span>
        ...
        <?php else: ?>
        <a class="page-subtitle-more" href="<?php if($userInfo==false) echo base_url('discussion/blog/'); else echo base_url('discussion/blog/'.$userInfo->id);?>">My Posts</a>
        <?php endif ?>
    </div>
