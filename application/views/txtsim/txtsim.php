...
<div id="3_term_component" style="width:130px; height:365px; float:left; overflow:auto; display:none;">
	<svg style="width:100px; height:720px; float: left;margin:10px;">
		<g id="3toolbar" >
            ...
            <g class="component" id="NMOS-ndtfet" term="3">
                <g class="drawing" transform="matrix(1,0,0,1,5,580)">
                    <rect fill="#ffffff" width="40" height="40" style="opacity:0" />
                    <path order="1" fill="none" stroke="#000000" stroke-width="1" d="M 0 20 L 10 20" />
                    <path order="2" fill="none" stroke="#000000" stroke-width="1" d="M 30 0 L 30 10" />
                    <path order="3" fill="none" stroke="#000000" stroke-width="1" d="M 30 30 L 30 40" />
            ...
            <g class="component" id="PMOS-ndtfet" term="3">
                <g class="drawing" transform="matrix(1,0,0,1,55,580)">
                    <rect fill="#ffffff" width="40" height="40" style="opacity:0" />
                    <path order="1" fill="none" stroke="#000000" stroke-width="1" d="M 0 20 L 10 20" />
                    <path order="2" fill="none" stroke="#000000" stroke-width="1" d="M 30 0 L 30 10" />
                    <path order="3" fill="none" stroke="#000000" stroke-width="1" d="M 30 30 L 30 40" />
            ...
            <text x="30" y="635" font-family="sans-serif" font-size="14px" fill="black">ndtfet</text>

            <g class="component" id="NMOS-igzotft" term="3">
				<g class="drawing" transform="matrix(1,0,0,1,5,650)">
					<rect fill="#ffffff" width="40" height="40" style="opacity:0" />
					<path order="1" fill="none" stroke="#000000" stroke-width="1" d="M 0 20 L 10 20" />
					<path order="2" fill="none" stroke="#000000" stroke-width="1" d="M 30 0 L 30 10" />
					<path order="3" fill="none" stroke="#000000" stroke-width="1" d="M 30 30 L 30 40" />
			...
			<g class="component" id="PMOS-igzotft" term="3">
				<g class="drawing" transform="matrix(1,0,0,1,55,650)">
					<rect fill="#ffffff" width="40" height="40" style="opacity:0" />
					<path order="1" fill="none" stroke="#000000" stroke-width="1" d="M 0 20 L 10 20" />
					<path order="2" fill="none" stroke="#000000" stroke-width="1" d="M 30 0 L 30 10" />
					<path order="3" fill="none" stroke="#000000" stroke-width="1" d="M 30 30 L 30 40" />
			...
			<text x="30" y="705" font-family="sans-serif" font-size="14px" fill="black">igzotft</text>
		</g>
	</svg>
</div>
...
<div id="4_term_component" style="width:130px; height:365px; float:left; overflow:auto; display:none;">
	<svg style="width:100px; height:370px; float: left;margin:10px;">
        ...
        <g class="component" id="NMOS-eJIM" term="4">
            <g class="drawing" transform="matrix(1,0,0,1,5,300)">
                <rect fill="#ffffff" width="40" height="40" style="opacity:0" />
                <path order="1" fill="none" stroke="#000000" stroke-width="1" d="M 0 20 L 10 20" />
                <path order="2" fill="none" stroke="#000000" stroke-width="1" d="M 30 0 L 30 10" />
        ...
        <g class="component" id="PMOS-eJIM" term="4">
            <g class="drawing" transform="matrix(1,0,0,1,55,300)">
                <rect fill="#ffffff" width="40" height="40" style="opacity:0" />
                <path order="1" fill="none" stroke="#000000" stroke-width="1" d="M 0 20 L 10 20" />
                <path order="2" fill="none" stroke="#000000" stroke-width="1" d="M 30 0 L 30 10" />
