	        ...
	        <div id="ModelLibraryIntroBox" class="clearfix">
	            <div id="ModelLibraryIntroBoxContainer" class="clearfix">
	                ...
	                <div id="MLTextBox" class="clearfix">
	                    <p>
	                    <span class="textTitle">Expanding model library</span><span ><br /><br /></span><span >It is the intention of iMOS to provide an authoring tool for model developer to upload their model implemented in Verilog-A code directly to iMOS for users to test and evaluate. Currently we are using the Automatic Device Model Synthesizer &#x28;ADMS&#x29; together with experienced programmers to help the compilation of worthwhile models to the i-MOS platform.</span><span ><br /><br /></span><a href="<?php echo base_url(); ?>">&gt; Launch Model Library</a><br />
	                    </p>
	                </div>
	            ...
	            <div id="UserExperienceBox" class="clearfix">
	                ...
	                <div id="ExperienceBox" class="clearfix">
	                    ...
	                    <div id="EBox" class="clearfix">
	                        ...
	                        <span>“ <?php echo htmlspecialchars($entry->comment); ?> ”</span><br />
	                        </p>
	                        <p class="EMessageNameText">
	                        <span><?php echo htmlspecialchars($entry->first_name . ' ' . $entry->last_name . ', ' . $entry->organization); ?></span><br />
	                        </p>
	                    </div>
	                    <? endif; ?>
	                ...
	                <div id="iMosActivitiesBox" class="clearfix">
	                    ...
	                    <div id="iMOSActivitiesTextBox" class="clearfix">
	                        <p class="iMosActivityColumn1">
								...
								<span class="iMosActivityTitle"><?php echo date('d M Y', $entry->date); ?></span>
								<br />
								<span class="iMosActivityContent"><?php echo $entry->content; ?></span>
								<br />
								<br />
								<?php endfor; ?>
	                        </p>
