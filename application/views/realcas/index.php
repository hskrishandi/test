                                    ...
                                    <div class="shadow-border">
                                        ...
                                        <div class="broader setup">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control clear-area-0" id="bti" name="bti"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="tcyc">TCYC=</label>
                                                <input type="text" class="form-control clear-area-0" id="tcyc" name="tcyc"/> ns
                                            </div>
                                            <div class="form-group">
                                                <label for="hci">HCI=</label>
                                                <input type="text" class="form-control clear-area-0" id="hci" name="hci"/>
                                            </div>
                                        </div>
                                        <div class="broader setup">
                                            <div class="form-group">
                                                <label for="tstep">tstep=</label>
                                                <input type="text" class="form-control clear-area-0" id="tstep" name="tstep"/> ns
                                            </div>
                                            <div class="form-group">
                                                <label for="tpre">tpre=</label>
                                                <input type="text" class="form-control clear-area-0" id="tpre" name="tpre"/> year
                                            </div>
                                            <div class="form-group">
                                                <label for="np">NP=</label>
                                                <input type="text" class="form-control clear-area-0" id="np" name="np"/>
                                            </div>
                                        </div>
