	...
	$.fn.fileupload = function(options) {
		return $(this).each(function() {
			...
			.change(function() {
                ...
                // This is callback for ajaxSubmit() Leon@20170721
                var uploadOptions = {
                    success: load
                }
				form.ajaxSubmit(uploadOptions); // Change from `form.submit()` to `form.ajaxSubmit()`, because we need to add the Authorization to the header using functions in token.js.  Leon@20170721
				that.prepend($(this));
...
$(function() {
     ...
     * - Upload
     *
     * Note that `New` is not in this file, it locates in js/realcas/doc_ready.js:402, dun ask me why, I am also a maintainer... Good luck!
     * Leon@20170721
     */

    // New
    // please go to js/realcas/doc_ready.js:402
