	...
	var LogConnectionFailure =
	
	'Connection Failure.\nPlease reload (Press F5) the webpage.';
	
	var changePassSuccess =
	'Password Changed Success';
	
	var newPassMsg =
	
	'The new password has been sent to your E-mail address. Please follow the instructions to change the password.';
	
	var downloadAsNote =
	
	'Download locations depend on your browser settings.';

	var failUploadMsg = 

	'The uploaded file has an improper extension or format.';